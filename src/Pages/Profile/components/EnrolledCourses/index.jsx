...
import { selectEnrolledCourses, FetchEnrolledCourses, Fetch as fetchEnrolledCourses } from "store/States/EnrolledCourses"
...
const Loader = ({
  ...
  useEffect(() => {
    console.log("popo", userContent.userData._id)
    fetchEnrolledCourses(userContent.userData._id)
  }, [fetchEnrolledCourses])
